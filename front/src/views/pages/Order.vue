    ...
    <div class="flex flex-col md:flex-row gap-8">
      <div class="md:w-1/2">
        <div class="card flex flex-col gap-4">
          <div class="font-semibold text-xl">주문 기본 정보</div>
          <div class="flex flex-col gap-2">
            <table>
              ...
              <tr>
                ...
                <th>거래처</th>
                <td>
                  <Select v-model="dropdownItem" :options="dropdownItems" optionLabel="name" placeholder="거래처를 선택해주세요." />
                </td>
              </tr>
              <tr>
                <th>거래처 담당자</th>
                <td>
                  <Select v-model="dropdownItem" :options="dropdownItems" optionLabel="name" />
                </td>
                <th>비고</th>
                <td>
                  <InputText type="text" />
